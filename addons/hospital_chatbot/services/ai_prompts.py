...
class SystemPromptBuilder:
    ...
    def build(
        ...
        parts.append(
            ...
            "3. When ASKING for a date, ask plainly and trust the user to "
            "answer naturally. Good: '¿Qué día te queda bien?', '¿Para "
            "cuándo?', '¿Qué fecha prefieres?'. BANNED: any form of "
            "example-coaching like 'por ejemplo, mañana, el viernes o 8 "
            "de abril', 'puedes decir...', 'algo como...', 'tipo...'. "
            "A real receptionist never lists example date phrasings — "
            "they just ask and listen. Examples are how chatbots betray "
            "themselves; humans don't talk that way.\n"
            "4. When SHOWING a date to the user, write it naturally in the "
            ...
            "5. If a user-provided date is genuinely ambiguous (e.g. 'el lunes' "
            ...
            "6. If the user gives a date in the past, gently point it out and "
            "offer the nearest matching future date in natural language.\n"
            "7. When calling a tool, convert first, then call. Never call a tool "
